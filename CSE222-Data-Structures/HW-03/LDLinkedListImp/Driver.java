...
public class Driver{
	public static void main(String[] args){
		...
		System.out.println("-----------------------------------------");
		System.out.println("LD LinkedList structure");
		System.out.println("-----------------------------------------\n");
		...
		try{
			...
			System.out.println(myStreet2.toString());
		}catch (Exception e){
			System.out.println(e);
		}
		...
		try{
			...
			System.out.println(Market.focus());
		} catch (Exception e){
			System.out.println(e);
		}
		...
		System.out.println("\nExecution time in nanoseconds / 100000: " + timeElapsed/100000);
